...
* laut.fm.server_status(CALLBACK)
...
* "Demo":http://lautde.github.com/lautfm_js_tools/station.current_song_auto.html ("API URL":http://api.laut.fm/station/eins/current_song)
